        ...
        <div class="box">
            ...
            <div class="box-body">
                <div>
                    ...
                    @if(!$is_edit)
                        <form id="user" method="post" action="{{route('user.store')}}">
                            @else
                                <form id="user" method="post" action="{{route('user.update',[$user->id])}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 has-feedback{{ $errors->has('last_name') ? ' has-error' : '' }}">
